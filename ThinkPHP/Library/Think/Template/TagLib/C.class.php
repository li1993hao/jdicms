...
class C extends  TagLib{
    ...
    protected $tags   =  array(
        ...
        'share' =>array('attr'=>'style,text,extra','close'=>0),
    ...
    public function _linkgroup($tag, $content){
        ...
        $parse = '<?php echo CC(\'LINK_GROUP\',\''.$group.'\')?>';
        return $parse;
    }
