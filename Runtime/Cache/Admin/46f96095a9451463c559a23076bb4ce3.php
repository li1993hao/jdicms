...
<!-- basic styles -->
<link href="/jdicms/Public/vendor/ace/css/bootstrap.min.css" rel="stylesheet" />
<link rel="stylesheet" href="/jdicms/Public/vendor/ace/css/font-awesome.min.css" />

<!--[if IE 7]>
<link rel="stylesheet" href="/jdicms/Public/vendor/ace/css/font-awesome-ie7.min.css" />
<![endif]-->

<!-- page specific plugin styles -->
<link rel="stylesheet" href="/jdicms/Public/vendor/ace/css/jquery-ui-1.10.3.custom.min.css" />
<link rel="stylesheet" href="/jdicms/Public/vendor/ace/css/jquery.gritter.css" />
<!-- fonts -->

<!-- ace styles -->

<link rel="stylesheet" href="/jdicms/Public/vendor/ace/css/ace.min.css" />
<link rel="stylesheet" href="/jdicms/Public/vendor/ace/css/ace-rtl.min.css" />
<link rel="stylesheet" href="/jdicms/Public/vendor/ace/css/ace-skins.min.css" />

<link rel="stylesheet" href="/jdicms/Public/Admin/css/comm.css" />
<!--[if lte IE 8]>
<link rel="stylesheet" href="/jdicms/Public/vendor/ace/css/ace-ie.min.css" />
<![endif]-->

<!--[if !IE]> -->

<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/jquery-2.0.3.min.js"></script>

<!-- <![endif]-->

<!--[if IE]>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/jquery-1.10.2.min.js"></script>
<![endif]-->

<!-- ace settings handler -->

<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/ace-extra.min.js"></script>

<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->

<!--[if lt IE 9]>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/html5shiv.js"></script>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/respond.min.js"></script>
<![endif]-->
...
<div class="main-container" id="main-container">
	...
	<script type="text/javascript" src="/jdicms/Public/vendor/uploadify/jquery.uploadify.min.js"></script>
							...
							<?php case "picture_union": ?><div class="controls">
								...
								<script type="text/javascript">
									...
									function uploadPicture<?php echo ($o_key); ?>(file, data){
										...
										var src = '';
										if(data.status){
											src = data.url || '/jdicms' + data.path
											$("#cover_id_<?php echo ($o_key); ?>").parent().find('.upload-img-box').append(
												'<div class="upload-pre-item" val="' + data.id + '"><img src="/jdicms' + src + '" ondblclick="removePicture<?php echo ($o_key); ?>(this)"/></div>'
											);
														...
														function uploadPicture<?php echo ($o_tab_key); ?>(file, data){
															...
															if(data.status){
																...
																$("#cover_id_<?php echo ($o_tab_key); ?>").parent().find('.upload-img-box').append(
																	'<div class="upload-pre-item" val="' + data.id + '"><img src="/jdicms' + src + '" ondblclick="removePicture<?php echo ($o_tab_key); ?>(this)"/></div>'
																);
...
<script type="text/javascript">
    !function(){
        var str = "<script src='/jdicms/Public/vendor/ace/js/jquery.mobile.custom.min.js'>"+"<"+"script>";
        if("ontouchend" in document) document.write(str);
    }();
</script>
<script src="/jdicms/Public/vendor/ace/js/bootstrap.min.js"></script>
<script src="/jdicms/Public/vendor/ace/js/typeahead-bs2.min.js"></script>

<!-- page specific plugin scripts -->

<!--[if lte IE 8]>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/excanvas.min.js"></script>
<![endif]-->

<script type="text/javascript"  src="/jdicms/Public/vendor/ace/js/jquery-ui-1.10.3.custom.min.js"></script>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/jquery.ui.touch-punch.min.js"></script>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/jquery.slimscroll.min.js"></script>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/jquery.easy-pie-chart.min.js"></script>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/jquery.sparkline.min.js"></script>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/flot/jquery.flot.min.js"></script>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/flot/jquery.flot.pie.min.js"></script>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/flot/jquery.flot.resize.min.js"></script>

<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/bootbox.min.js"></script>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/jquery.gritter.min.js"></script>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/bootstrap-wysiwyg.min.js"></script>

<!-- ace scripts -->

<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/ace-elements.min.js"></script>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/ace.min.js"></script>
<script type="text/javascript" src="/jdicms/Public/vendor/ace/js/jquery.hotkeys.min.js"></script>
<script type="text/javascript">
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/jdicms", //当前网站地址
            "APP"    : "/jdicms/admin.php", //当前项目地址
            "PUBLIC" : "/jdicms/Public", //项目公共目录地址
...
<script type="text/javascript" src="/jdicms/Public/Admin/think.js"></script>
<script type="text/javascript" src="/jdicms/Public/Admin/js/common.js"></script>
